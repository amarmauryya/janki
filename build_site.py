        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (typeof Flw !== 'undefined') {
                const flowerOptions = {
                    ...
                    maxDeepnessMajor: 2, maxDeepnessMajorVar: 2, maxDeepnessMaster: 5, maxDeepnessMasterVar: 4,
                ...
                const flowerObserver = new IntersectionObserver((entries) => {
                    entries.forEach(e => {
                        if(e.isIntersecting && !e.target.drawn) {
                            ...
                            setTimeout(() => {
                                Flw.LimitedFlower.create(e.target, flowerOptions, true);
                            }, 500);
                        }
                    });
                }, { threshold: 0.1 });
                
                if (fLeft) flowerObserver.observe(fLeft);
                if (fRight) flowerObserver.observe(fRight);
            }
...
pages['index.html'] = ("home", """
    <section class="relative min-h-[80dvh] flex items-center pb-24 overflow-hidden">
        <div class="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 px-6 lg:px-10 items-center relative z-10">
            ...
            <div class="reveal flex justify-center lg:justify-end pr-0 lg:pr-16 relative z-10 mt-8 lg:mt-0">
                <div class="relative inline-block w-full max-w-[360px] md:max-w-[460px]">
                    <!-- Left Flower -->
                    <div id="flower-left" class="absolute top-[5%] -left-[30px] md:-left-[180px] w-[80px] md:w-[200px] h-[300px] md:h-[500px] pointer-events-none z-20"></div>
                    <!-- Right Flower -->
                    <div id="flower-right" class="absolute top-[5%] -right-[30px] md:-right-[180px] w-[80px] md:w-[200px] h-[300px] md:h-[500px] pointer-events-none z-20" style="transform: scaleX(-1);"></div>
